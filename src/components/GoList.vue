...
<div class="relative">
    ...
    <Listbox v-model="goSelection" :options="formattedToDisplay" :multiple="true" @change="clickSelection" listStyle="height:300px" :filter="true" :filterFields="filterFields">
        <template #header>
