...
<template>
   ...
   <div class="flex">
    ...
    <div v-if="loaded && uniprotDBFilled">
        ...
        {{selectedProteome.name}} contains {{selectedProteome.protein_number}} of your proteins </span></p>
...
export default defineComponent({
    ...
    setup(_, { emit }){
        ...
        return { loadDroppedFile, loadExample, xlsDropped, loaded, uniprotDBFilled, jsonData, selectedColumns, columns, onSelection, headers, filters, canShowTable, proteomes, selectedProteome, clickLoadButton, loadFileName, FN};
    }
});
</script>
